...
// End Cross Module References
	...
	static FName NAME_ATankGameModeBase_UpdateScore = FName(TEXT("UpdateScore"));
	void ATankGameModeBase::UpdateScore(int32 TotalScore)
	{
		TankGameModeBase_eventUpdateScore_Parms Parms;
		Parms.TotalScore=TotalScore;
		ProcessEvent(FindFunctionChecked(NAME_ATankGameModeBase_UpdateScore),&Parms);
	}
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATankGameModeBase_GameOver_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//Only in blueprints impolementation use for display results\n" },
		{ "ModuleRelativePath", "GameModes/TankGameModeBase.h" },
		{ "ToolTip", "Only in blueprints impolementation use for display results" },
	};
#endif
	...
	struct Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics
	{
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::NewProp_TotalScore = { "TotalScore", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TankGameModeBase_eventUpdateScore_Parms, TotalScore), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::NewProp_TotalScore,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "GameModes/TankGameModeBase.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATankGameModeBase, nullptr, "UpdateScore", nullptr, nullptr, sizeof(TankGameModeBase_eventUpdateScore_Parms), Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08080800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATankGameModeBase_UpdateScore()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATankGameModeBase_UpdateScore_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATankGameModeBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATankGameModeBase_GameOver, "GameOver" }, // 382528932
		{ &Z_Construct_UFunction_ATankGameModeBase_GameStart, "GameStart" }, // 1381270125
		{ &Z_Construct_UFunction_ATankGameModeBase_UpdateScore, "UpdateScore" }, // 1579765625
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ATankGameModeBase, 2860499418);
