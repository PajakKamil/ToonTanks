...
// Sets default values
APawnBase::APawnBase() : Score(200)
{
 	// Set this pawn to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;

	CapsuleComp = CreateDefaultSubobject<UCapsuleComponent>(TEXT("Capsule Colliider"));
...
void APawnBase::RoteteTurret(FVector LookAtTarget)
{
